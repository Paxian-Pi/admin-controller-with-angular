...
export const navigation: FuseNavigation[] = [
        ...
        children : [
            {
                ...
                // type     : 'collapsable',
                type     : 'item',                     // Use type 'collapsable', if the 'children' array is active
                icon     : 'dashboard',
                url      : '/apps/dashboards/project'  // Remove this url, if the 'project' child is used!
                // children : [
                //     {
                //         id   : 'analytics',
                //         title: 'Analytics',
    ...
    //             type    : 'item',                   // Use type 'collapsable', if the 'children' array is active
    //             icon    : 'receipt',
    //             url     : '/pages/invoices/modern', // Remove this url, if the 'project' child is used!
    //             children: [
    //                 {
    //                     id   : 'modern',
    //                     title: 'Modern',
